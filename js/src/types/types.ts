...
export type CommaSeparatedList<T extends string | number, N = 0> = N extends 46 ? CommaSeparatedListSegment<T> : N extends number ? CommaSeparatedList<T, Inc<N>> | `${CommaSeparatedListSegment<T>},${CommaSeparatedList<T, Inc<N>>}` : never;
